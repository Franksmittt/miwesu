...
export const metadata: Metadata = {
  ...
  description: "Check availability for MIWESU GAME FARM residences and conservation harvest. Hunter's House and Rooibok Kraal, Makoppa district Thabazimbi. Contact concierge for live availability and vetting.",
