      ...
      <main id="main-content" className="min-h-screen bg-marble">
        ...
        <section className="bg-onyx text-white py-12 sm:py-16 border-y border-white/10">
          <SpeciesBentoGrid
            variant="dark"
            cells={[
              { label: 'Adult Bull Weight', value: '500–900 kg' },
              { label: 'Trophy Benchmark', value: '40+ inches' },
              { label: 'Minimum Caliber', value: '.375 H&H' },
              { label: 'Lifespan', value: '15–20 years' },
            ]}
            footer={<CompareButton currentSpeciesSlug="cape-buffalo" currentSpeciesName="Cape Buffalo" />}
          />
        </section>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="flex flex-col md:flex-row md:items-stretch [&>*]:min-w-0 gap-12 mb-16 reveal">
              <div className="relative min-h-[280px] md:min-h-0 min-w-0 md:flex-1 md:basis-0 overflow-hidden rounded-sm">
                <Image
                  src="/images/cape-buffalo-shot-placement.png"
                  alt="Cape buffalo shot placement diagram: broadside vitals"
                  fill
        ...
        <section className="py-20 md:py-32 bg-onyx text-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="flex flex-col md:flex-row md:items-stretch [&>*]:min-w-0 gap-12 mb-16 reveal">
              ...
              <div className="relative min-h-[280px] md:min-h-0 min-w-0 md:flex-1 md:basis-0 overflow-hidden rounded-sm">
                <Image
                  src="/images/cape-buffalo-venison.png"
                  alt="Cape buffalo meat, game venison"
                  fill
