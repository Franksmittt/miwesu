...
export const metadata: Metadata = {
  ...
  description: 'Elite environmental stewardship at MIWESU: annual ecological census dictates harvest availability. Guardian\'s Pledge: silence, fair chase, respect. Anti-poaching, habitat restoration. Makoppa, Thabazimbi.',
  keywords: ['conservation', 'Guardian\'s Pledge', 'ethical hunting', 'fair chase', 'PHASA', 'anti-poaching', 'ecological census', 'sustainable use', 'Limpopo', 'Makoppa district', 'Thabazimbi', 'MIWESU GAME FARM'],
