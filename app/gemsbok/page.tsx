      ...
      <main className="min-h-screen bg-marble">
        <section className="relative h-[50vh] sm:h-[60vh] flex items-center justify-center overflow-hidden bg-onyx">
          <div className="absolute inset-0 z-0">
            <Image src="/images/home-species-gemsbok.jpg" alt="Gemsbok" fill className="object-cover opacity-50" priority />
        ...
        <section className="py-20 md:py-32 bg-marble">
          <div className="max-w-7xl mx-auto px-6">
            <div className="text-center reveal">
              ...
              <p className="font-sans text-gray-600 text-lg max-w-3xl mx-auto">Comprehensive information about the Gemsbok will be added here.</p>
            </div>
          </div>
        </section>
      </main>
