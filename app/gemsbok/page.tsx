      ...
      <main id="main-content" className="min-h-screen bg-marble">
        ...
        <section className="bg-onyx text-white py-12 sm:py-16 border-y border-white/10">
          <SpeciesBentoGrid
            variant="dark"
            cells={[
              { label: 'Adult Bull Weight', value: '180–240 kg' },
              { label: 'Trophy Benchmark', value: '40+ inches' },
              { label: 'Recommended Caliber', value: '.30-06' },
              { label: 'Lifespan', value: '18–20 years' },
            ]}
            footer={<CompareButton currentSpeciesSlug="gemsbok" currentSpeciesName="Gemsbok" />}
          />
        </section>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="flex flex-col md:flex-row md:items-stretch gap-12 mb-16 reveal">
              ...
              <div className="relative min-h-[280px] md:min-h-0 md:w-[calc(50%-1.5rem)] overflow-hidden rounded-sm">
                <Image
                  src="/images/gemsbok-hunting-stalk.png"
                  alt="Gemsbok in habitat, spot-and-stalk"
                  fill
            ...
            <div className="flex flex-col md:flex-row md:items-stretch gap-12 mb-16 reveal">
              <div className="relative min-h-[280px] md:min-h-0 md:w-[calc(50%-1.5rem)] overflow-hidden rounded-sm">
                <Image
                  src="/images/gemsbok-shot-placement.png"
                  alt="Gemsbok shot placement diagram"
                  fill
        ...
        <section className="py-20 md:py-32 bg-marble">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="flex flex-col md:flex-row md:items-stretch gap-12 mb-16 reveal">
              ...
              <div className="relative min-h-[280px] md:min-h-0 md:w-[calc(50%-1.5rem)] overflow-hidden rounded-sm">
                <Image
                  src="/images/gemsbok-bull-vs-cow.png"
                  alt="Gemsbok bull and cow comparison"
                  fill
                  className="object-cover object-center"
                  sizes="(max-width: 768px) 100vw, 50vw"
                />
        ...
        <section className="py-20 md:py-32 bg-onyx text-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="flex flex-col md:flex-row md:items-stretch gap-12 mb-16 reveal">
              ...
              <div className="relative min-h-[280px] md:min-h-0 md:w-[calc(50%-1.5rem)] overflow-hidden rounded-sm">
                <Image
                  src="/images/gemsbok-venison.png"
                  alt="Gemsbok venison"
                  fill
                  className="object-cover object-center"
                  sizes="(max-width: 768px) 100vw, 50vw"
