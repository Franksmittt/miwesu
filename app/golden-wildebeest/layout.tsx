...
export const metadata: Metadata = {
  ...
  openGraph: { ...generateOpenGraph('Golden Wildebeest Hunting Guide | Connochaetes taurinus', 'Comprehensive guide to Golden Wildebeest hunting at MIWESU Game Farm.', pageUrl, ogImage), locale: 'en_ZA' },
  twitter: generateTwitterCard('Golden Wildebeest Hunting Guide | Connochaetes taurinus', 'Comprehensive guide to Golden Wildebeest hunting at MIWESU Game Farm.', ogImage),
