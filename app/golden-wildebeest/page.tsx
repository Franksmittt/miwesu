      ...
      <main id="main-content" className="min-h-screen bg-marble">
        ...
        <section className="bg-onyx text-white py-12 sm:py-16 border-y border-white/10">
          <SpeciesBentoGrid
            variant="dark"
            cells={[
              { label: 'Adult Bull Weight', value: '180–270 kg' },
              { label: 'Trophy Benchmark', value: '28+ inches' },
              { label: 'Recommended Caliber', value: '.375 H&H' },
              { label: 'Lifespan', value: '15–20 years' },
            ]}
            footer={<CompareButton currentSpeciesSlug="golden-wildebeest" currentSpeciesName="Golden Wildebeest" />}
          />
        </section>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="flex flex-col md:flex-row md:items-stretch gap-12 mb-16 reveal">
              ...
              <div className="relative min-h-[280px] md:min-h-0 md:w-[calc(50%-1.5rem)] overflow-hidden rounded-sm">
                <Image
                  src="/images/golden-wildebeest-color-pattern.png"
                  alt="Golden wildebeest colour pattern"
                  fill
        ...
        <section className="py-20 md:py-32 bg-onyx text-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="flex flex-col md:flex-row md:items-stretch gap-12 mb-16 reveal">
              <div className="relative min-h-[280px] md:min-h-0 md:w-[calc(50%-1.5rem)] overflow-hidden rounded-sm">
                <Image
                  src="/images/golden-wildebeest-behavior.png"
                  alt="Golden wildebeest behaviour in habitat"
                  fill
                  className="object-cover object-center"
                  sizes="(max-width: 768px) 100vw, 50vw"
                />
        ...
        <section className="py-20 md:py-32 bg-marble">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="flex flex-col md:flex-row md:items-stretch gap-12 mb-16 reveal">
              ...
              <div className="relative min-h-[280px] md:min-h-0 md:w-[calc(50%-1.5rem)] overflow-hidden rounded-sm">
                <Image
                  src="/images/golden-wildebeest-hunting-stalk.png"
                  alt="Golden wildebeest in habitat, spot-and-stalk"
                  fill
                  className="object-cover object-center"
                  sizes="(max-width: 768px) 100vw, 50vw"
                />
            ...
            <div className="flex flex-col md:flex-row md:items-stretch gap-12 mb-16 reveal">
              <div className="relative min-h-[280px] md:min-h-0 md:w-[calc(50%-1.5rem)] overflow-hidden rounded-sm">
                <Image
                  src="/images/golden-wildebeest-shot-placement.png"
                  alt="Golden wildebeest shot placement diagram"
                  fill
        ...
        <section className="py-20 md:py-32 bg-onyx text-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="flex flex-col md:flex-row md:items-stretch gap-12 mb-16 reveal">
              ...
              <div className="relative min-h-[280px] md:min-h-0 md:w-[calc(50%-1.5rem)] overflow-hidden rounded-sm">
                <Image
                  src="/images/golden-wildebeest-trophy-bull.png"
                  alt="Golden wildebeest bull, trophy evaluation"
                  fill
                  className="object-cover object-center"
                  sizes="(max-width: 768px) 100vw, 50vw"
                />
        ...
        <section className="py-20 md:py-32 bg-marble">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16 reveal">
              ...
              <p className="font-sans text-gray-600 text-lg max-w-3xl mx-auto">
                Golden Wildebeest venison is identical in quality and characteristics to standard Blue Wildebeest. The meat is lean, flavorful, and highly regarded. Venison is handled professionally in line with food-safety and regulatory requirements.
              </p>
            </div>
            ...
            <div className="flex flex-col md:flex-row md:items-stretch gap-12 mb-16 reveal">
              ...
              <div className="relative min-h-[280px] md:min-h-0 md:w-[calc(50%-1.5rem)] overflow-hidden rounded-sm">
                <Image
                  src="/images/golden-wildebeest-venison.png"
                  alt="Golden wildebeest venison"
                  fill
                  className="object-cover object-center"
                  sizes="(max-width: 768px) 100vw, 50vw"
                />
