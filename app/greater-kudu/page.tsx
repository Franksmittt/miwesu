      ...
      <main id="main-content" className="min-h-screen bg-marble">
        ...
        <section className="bg-onyx text-white py-12 sm:py-16 border-y border-white/10">
          <SpeciesBentoGrid
            variant="dark"
            cells={[
              { label: 'Adult Bull Weight', value: '190–315 kg' },
              { label: 'Trophy Benchmark', value: '53+ inches' },
              { label: 'Recommended Caliber', value: '.300 Win Mag' },
              { label: 'Lifespan', value: '15–20 years' },
            ]}
            footer={<CompareButton currentSpeciesSlug="greater-kudu" currentSpeciesName="Greater Kudu" />}
          />
        </section>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid md:grid-cols-2 gap-12 mb-16 items-stretch reveal">
              ...
              <div className="relative h-full min-h-[500px] overflow-hidden rounded-sm">
                <Image
                  src="/images/greater-kudu-hunting-strategies.png"
                  alt="Greater kudu in bushveld habitat, spot-and-stalk context"
                  fill
                  className="object-cover"
            ...
            <div className="grid md:grid-cols-2 gap-12 mb-16 items-stretch reveal">
              <div className="relative h-full min-h-[500px] overflow-hidden rounded-sm">
                <Image
                  ...
                  alt="Greater kudu shot placement diagram: broadside vitals"
                  fill
