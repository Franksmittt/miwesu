...
export const metadata: Metadata = {
  ...
  description: 'MIWESU GAME FARM - Luxury game farm and hunting lodge in the Makoppa district, Thabazimbi, Limpopo. Plains game and trophy hunting, malaria-free Waterberg. Private residences, conservation harvest, safari. D1432 Road, 40km from Thabazimbi.',
  keywords: [
    'MIWESU GAME FARM',
    'Miwesu',
    'game farm',
