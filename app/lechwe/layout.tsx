...
export const metadata: Metadata = {
  ...
  openGraph: { ...generateOpenGraph('Lechwe Hunting Guide | Kobus leche', 'Comprehensive guide to Lechwe hunting at MIWESU Game Farm.', pageUrl, ogImage), locale: 'en_ZA' },
  twitter: generateTwitterCard('Lechwe Hunting Guide | Kobus leche', 'Comprehensive guide to Lechwe hunting at MIWESU Game Farm.', ogImage),
