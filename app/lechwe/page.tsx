      ...
      <main id="main-content" className="min-h-screen bg-marble">
        ...
        <section className="bg-onyx text-white py-12 sm:py-16 border-y border-white/10">
          <SpeciesBentoGrid
            variant="dark"
            cells={[
              { label: 'Adult Ram Weight', value: '60–120 kg' },
              { label: 'Trophy Benchmark', value: '20+ inches' },
              { label: 'Recommended Caliber', value: '.270 Win' },
              { label: 'Lifespan', value: '12–15 years' },
            ]}
            footer={<CompareButton currentSpeciesSlug="lechwe" currentSpeciesName="Lechwe" />}
          />
        </section>
