...
export const metadata: Metadata = {
  ...
  openGraph: { ...generateOpenGraph('Red Hartebeest Hunting Guide | Alcelaphus buselaphus caama', 'Comprehensive guide to Red Hartebeest hunting at MIWESU Game Farm.', pageUrl, ogImage), locale: 'en_ZA' },
  twitter: generateTwitterCard('Red Hartebeest Hunting Guide | Alcelaphus buselaphus caama', 'Comprehensive guide to Red Hartebeest hunting at MIWESU Game Farm.', ogImage),
