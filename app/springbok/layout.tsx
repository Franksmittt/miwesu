...
export const metadata: Metadata = {
  ...
  openGraph: generateOpenGraph('Springbok Hunting Guide | Antidorcas marsupialis', 'Comprehensive guide to Springbok hunting at MIWESU Game Farm.', pageUrl, `${baseUrl}/og-image.jpg`),
