      ...
      <main id="main-content" className="min-h-screen bg-marble">
        ...
        <section className="bg-onyx text-white py-12 sm:py-16 border-y border-white/10">
          <SpeciesBentoGrid
            variant="dark"
            cells={[
              { label: 'Adult Ram Weight', value: '30–50 kg' },
              { label: 'Trophy Benchmark', value: '14+ inches' },
              { label: 'Recommended Caliber', value: '.243 Win' },
              { label: 'Lifespan', value: '10–12 years' },
            ]}
            footer={<CompareButton currentSpeciesSlug="springbok" currentSpeciesName="Springbok" />}
          />
        </section>
            ...
            <div className="flex flex-col md:flex-row md:items-stretch gap-12 mb-16 reveal">
              ...
              <div className="relative min-h-[280px] md:min-h-0 md:w-[calc(50%-1.5rem)] overflow-hidden">
                <Image
                  ...
                  alt="Springbok ewe in grassland"
                  fill
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="flex flex-col md:flex-row md:items-stretch gap-12 mb-16 reveal">
              ...
              <div className="relative min-h-[280px] md:min-h-0 md:w-[calc(50%-1.5rem)] overflow-hidden">
                <Image
                src="/images/4springbok-ram-portrait-02.png"
                alt="Springbok horn configuration"
                fill
                className="object-cover shadow-luxury"
              />
              </div>
