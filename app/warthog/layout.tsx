...
export const metadata: Metadata = {
  ...
  openGraph: { ...generateOpenGraph('Warthog Hunting Guide | Phacochoerus africanus', 'Comprehensive guide to Warthog hunting at MIWESU Game Farm.', pageUrl, ogImage), locale: 'en_ZA' },
  twitter: generateTwitterCard('Warthog Hunting Guide | Phacochoerus africanus', 'Comprehensive guide to Warthog hunting at MIWESU Game Farm.', ogImage),
