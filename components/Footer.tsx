  ...
  return (
    <footer className="bg-onyx border-t border-white/5">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="py-12 grid grid-cols-2 sm:grid-cols-4 gap-8 sm:gap-12">
          <div>
            <h4 className="text-[10px] uppercase tracking-[0.25em] text-gold-500 font-bold mb-4 font-sans">
              Stay
            </h4>
            <ul className="space-y-3 font-sans text-sm">
              <li><Link href="/residences" className="text-gray-400 hover:text-white transition-colors flex items-center gap-1 group"><span>Residences</span><ArrowUpRight className="w-3 h-3 opacity-0 -translate-y-0.5 translate-x-0.5 group-hover:opacity-100 group-hover:translate-y-0 group-hover:translate-x-0 transition-all" /></Link></li>
              <li><Link href="/residences/homestead" className="text-gray-400 hover:text-white transition-colors">The Homestead</Link></li>
              <li><Link href="/residences/stone-villa" className="text-gray-400 hover:text-white transition-colors">The Stone Villa</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-3 font-sans text-sm">
              ...
              <li><Link href="/wildlife" className="text-gray-400 hover:text-white transition-colors">Wildlife</Link></li>
              <li><Link href="/conservation" className="text-gray-400 hover:text-white transition-colors">Conservation</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-3 font-sans text-sm">
              <li><Link href="/rates" className="text-gray-400 hover:text-white transition-colors">Rates</Link></li>
              <li><Link href="/availability" className="text-gray-400 hover:text-white transition-colors">Availability</Link></li>
        ...
        {/* Bottom bar */}
        <div className="py-6 flex flex-col sm:flex-row justify-between items-center gap-4 border-t border-white/5">
