      ...
      <div className="mx-auto max-w-7xl">
        <div className="grid gap-14 lg:grid-cols-2 lg:gap-16 lg:items-stretch">
          <div className="flex min-h-0 min-w-0 flex-col lg:h-full">
            ...
            <div className="mt-10 space-y-10 lg:mt-auto lg:pt-10">
              <div className="grid grid-cols-3 gap-px overflow-hidden rounded-xl border border-white/10 bg-white/10 shadow-noir-sm">
                {LINES.map((name) => (
                  <div
                    key={name}
              ...
              <Link
                href="/wood"
                className="group inline-flex min-h-12 w-fit items-center gap-2 border border-gold-500/45 bg-gold-500/[0.08] px-8 py-3 font-sans text-xs font-semibold uppercase tracking-[0.2em] text-gold-300 transition-all duration-200 hover:border-gold-400 hover:bg-gold-500/15 hover:text-gold-200"
              >
                Wood &amp; thermal
          ...
          {/* Kiln credential, one surface, no nested stat cards — fills column height to match editorial side */}
          <aside className="flex min-h-0 flex-col lg:h-full">
            <div className="liquid-glass-dark relative flex h-full min-h-0 flex-col overflow-hidden rounded-2xl border border-white/[0.09] p-8 shadow-noir-lg sm:p-10">
              <div
              ...
              <div className="mt-auto flex flex-col gap-8 border-t border-white/10 pt-8 sm:flex-row sm:items-end sm:justify-between sm:gap-10">
                <div>
