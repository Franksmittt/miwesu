...
const content: Record<string, BlogSection[]> = {
  'saps-520-firearm-permit-us-hunters': [
    {
      h2: 'The legal landscape of South African firearm importation', paragraphs: [
      ...
      h2: 'SAPS 520 requirements and common pitfalls at O.R. Tambo', paragraphs: [
        ...
        'Gather your passport, flight details, and firearm specifications. Complete the Miwesu SAPS 520 generator with applicant details and up to four firearms. Download the PDF and submit it as required by SAPS. Renew your CBP Form 4457 if it is near expiry. On arrival, present both documents. Our concierge can assist with transfer logistics to the reserve. Fair Chase and PHASA-compliant practices start with compliant paperwork.', ], }, ], '300-win-mag-blue-wildebeest-terminal-performance': [
    {
      ...
      h2: 'Kinetic energy and bullet selection in the brush', paragraphs: [
        ...
        'Heart-lung placement behind the shoulder is the gold standard. Quartering-away angles allow deep penetration through the vitals. Avoid marginal angles and ensure a clear exit path. The conservation harvest at MIWESU is science-led: harvest quotas follow our annual ecological census. When you book a stay, you are engaging with an operation that prioritises Fair Chase and PHASA standards.', ], }, ], 'exclusive-16-sleeper-luxury-lodge-thabazimbi': [
    {
      ...
      h2: "Hunter's House: architecture and amenities", paragraphs: [
      ...
      h2: 'Booking and availability', paragraphs: [
        'Exclusive use means the calendar is yours once confirmed. Check availability for your dates and submit an enquiry. Our concierge will confirm rates and logistics. Hunter\'s House is the choice for corporate safari retreats, large families, and hunting syndicates from Gauteng and beyond. Guardian\'s Pledge and Conservation Harvest principles apply to every stay.', ], }, ], 'art-of-authentic-south-african-biltong-making': [
    {
      h2: 'The cultural heritage of the South African biltong hunt', paragraphs: [
      ...
      h2: 'Processing: cuts, vinegar, and coriander', paragraphs: [
        ...
        'From wet carcass to dry biltong, a standard conversion rate in South African processing is around 38%. Species, fat content, and cut selection affect the final yield. Use the Miwesu Biltong Yield Calculator to estimate dry biltong from wet carcass weight for any of our 14+ managed species. It is a practical tool for planning and for understanding the economics of your harvest.', ], }, ], 'rowland-ward-trophy-standards-greater-kudu': [
    {
      ...
      h2: 'Rowland Ward measurement methodology', paragraphs: [
        ...
        'The Kudu rut influences behaviour and visibility. Winter months (May–August) often improve sight lines as deciduous foliage thins. Early morning and late afternoon are prime. Our professional hunters and trackers know the ground and the animals. For specific trophy expectations and conservation quotas, contact the MIWESU concierge. We are here to match your goals with what the reserve can sustainably offer.', ], }, ], 'ethical-shot-placement-cape-buffalo-fused-boss': [
    {
      ...
      h2: 'Legal minimum and bullet selection', paragraphs: [
      ...
      h2: 'Broadside vs quartering-away', paragraphs: [
        'Broadside: aim one-third up the body, just behind the shoulder. Quartering-away: aim for the off-side shoulder so the bullet crosses the vitals. Avoid marginal angles and ensure a clear path to the heart or lungs. Our PHASA-aligned team is on hand to advise and to follow up if required. Fair Chase and respect for the animal define the MIWESU experience.', ], }, ], 'malaria-free-celestial-safaris-waterberg': [
    {
      h2: 'Why malaria-free matters', paragraphs: [
        'The Makoppa Dome and Waterberg region are malaria-free. That is a significant advantage for international families and for travellers who prefer to avoid prophylactics. Unlike parts of the Greater Kruger, Thabazimbi and the Limpopo bushveld around MIWESU offer clear air, open horizons, and safe, multi-generational travel without chemoprophylaxis.', ], }, {
      h2: 'What you actually do on the farm', paragraphs: [
        'Stays centre on guided game drives and walking time with your team, birding and quiet wildlife viewing, and the Homestead’s boma, lapa, and braai rhythm. Rooibok Kraal offers intimacy beside the dam—outdoor braai, deck time, and privacy—not a separate menu of ticketed “safari products.”', ], }, {
      h2: 'From afternoon wildlife to evening at the fire', paragraphs: [
        'A typical day can move from morning game drive or walk to lunch at the lodge, then an afternoon at the pool or in the shade. As light fades, the boma and coals take over. The “A Day in Eden” timeline on our site captures this rhythm. For observers and non-hunting partners, the Waterberg and MIWESU sell honest bushveld time together.', ], }, ], 'conservation-harvest-esg-environmental-stewardship': [
    {
      h2: 'Defining the Conservation Harvest', paragraphs: [
      ...
      h2: 'Census, quotas, and science', paragraphs: [
      ...
      h2: 'From field to facility, no invented metrics', paragraphs: [
    ...
    {
      h2: 'Ancient geology, modern connectivity', paragraphs: [
      ...
      h2: 'Work-from-anywhere at both residences', paragraphs: [
      ...
      h2: 'Corporate retreats and custom itineraries', paragraphs: [
        'For custom itineraries and corporate retreat brochures, contact the MIWESU concierge. We can outline availability, activities, and how a stay aligns with the Conservation Harvest. High-speed internet game lodge Limpopo is not an oxymoron here; it is the standard.', ], }, ], 'golden-vs-blue-wildebeest-african-plains-game': [
    {
      h2: 'Genetic origins of the Golden variant', paragraphs: [
      ...
      h2: 'Behaviour, habitat, and ballistics', paragraphs: [
      ...
      h2: 'Compare all species at MIWESU', paragraphs: [
        'Use our Compare Species tool to view side-by-side data for the 14+ managed species. Ballistics, habitat, and trophy minimums are summarised in one place. It is a practical resource for the technical hunter planning a conservation harvest in the Makoppa district, Thabazimbi.', ], }, ], 'limpopo-hunting-season-2026-weather-tactics': [
    {
      h2: 'From summer rainfall to dry winter', paragraphs: [
      ...
      h2: 'Visibility and stalking opportunities', paragraphs: [
        ...
        'Pack for cool dawn and dusk and warm midday. Neutral, breathable clothing and quality boots are essential. A hat, sunscreen, and binoculars round out the kit. Check our live availability calendar for real-time dates. The Conservation Harvest at MIWESU is seasonal in rhythm but year-round in commitment to Fair Chase and PHASA standards.', ], }, ], 'livingstone-eland-harvesting-africas-largest-antelope': [
    {
      ...
      h2: 'Caliber: .338 Win Mag and 9.3x62mm', paragraphs: [
      ...
      h2: 'Tracking and trophy expectations', paragraphs: [
        'Eland herds can cover ground quickly. Tracking in the Makoppa district demands fitness and patience. For large plains game packages and specific trophy expectations, contact the MIWESU concierge. We tailor enquiries to what the reserve can sustainably offer and to your experience level.', ], }, ], 'stone-villa-experience-intimate-luxury-makoppa': [
    {
      h2: 'The 6-sleeper boutique lodge', paragraphs: [
      ...
      h2: 'Outdoor braai and Miwesu Premium Firewood', paragraphs: [
        'The outdoor braai overlooks the dam. We supply Miwesu Premium Firewood (Sekelbos, Geelhak, Braai Mix) for an authentic bushveld braai. Smoke, stars, and silence are central to the sensory experience at Rooibok Kraal. Game drives, walks, and other farm activities are arranged with your hosts as part of the stay; privacy at Rooibok Kraal is absolute.', ], }, {
      h2: 'Exclusive romantic and small-family getaways', paragraphs: [
        'Ideal for couples, small families, or a small group seeking a 6-sleeper private safari villa. The outdoor deck and dam setting frame quiet evenings after the day in the veld. For availability and direct booking, use our enquiry form. The Rooibok Kraal experience is intimate luxury in the Makoppa Dome.', ], }, ], 'south-africa-vs-usa-hunting-regulations': [
    {
      h2: 'Federal-state vs national-provincial systems', paragraphs: [
      ...
      h2: 'PHASA and ethical standards', paragraphs: [
      ...
      h2: 'CITES and trophy export', paragraphs: [
        'CITES permits may be required for certain species when exporting trophies. Timing and paperwork must be exact to avoid delays. We offer administrative support for legal and taxidermy logistics. Contact the MIWESU concierge for full assistance with South African and international requirements.', ], }, ], 'transparency-conservation-live-telemetry-dashboard': [
    {
      h2: 'From opaque to accountable stewardship', paragraphs: [
      ...
      h2: 'What we share, and how to go deeper', paragraphs: [
      ...
      h2: 'Engineered heat and product rigour', paragraphs: [
